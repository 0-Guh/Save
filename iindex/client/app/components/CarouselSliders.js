            ...
            {ItemsSlider.map(_Item => {
                ...
                return (
                    <SwiperSlide key={MyKyID}>
                        ...
                        <article className="bg-cover bg-center min-h-[70vh] px-5 pt-48 flex flex-col items-center md:flex-row md:items-start md:pl-20 md:pt-40" style={LinearGradientBack}>
                            ...
                            <section className="text-center my-10 max-w-xl md:text-start md:ml-8 md:my-0 2xl:ml-10">
